...
export default [
  {
    ...
    items: [
      ...
      { text: 'Comparable和Comparator的区别', link: basePath + 'Comparable和Comparator的区别' },
      { text: '有了Comparable为什么还需要Comparator', link: basePath + '有了Comparable为什么还需要Comparator' },
      ...
      { text: '说说Java中集合的排序方式', link: basePath + '说说Java中集合的排序方式' },
